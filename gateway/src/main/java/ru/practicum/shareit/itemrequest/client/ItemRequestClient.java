...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(ItemRequestRequestedDto itemRequestDto, Long userId) {
        return post("", userId, itemRequestDto);
    }

    public ResponseEntity<Object> findAllByUserId(Integer from, Integer size, Long userId) {
